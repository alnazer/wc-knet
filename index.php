    ...
    function alnazer_init_wc_knet_payment(): void
    {
        ...
        class WC_Payment_Gateway_KNET extends WC_Payment_Gateway
        {
            ...
            public function init_form_fields()
            {
                $this->form_fields = array(
                    ...
                    'is_redirect_mode' => array(
                        'title' => 'KNET REDIRECT page',
                        'label' => 'Enable KNET REDIRECT page',
                        'type' => 'checkbox',
                        'description' => __("تم اضافة هذة الخاصية نظراً لتحديث الكي نت الجديد للمشتركين ب 4/9/2023 اذا لم يطلب منك الكي نت تفعبل خاصية اعادة التوجية لا تقم بتفعيلها", "wc-knet"),
                        'default' => 'no',
                        'desc_tip' => false,
                    ),
                    ...
                    'pending_order_status' => array(
                        'title' => __('Pending Payment Order Status', 'wc_visa'),
                        'description' => __('The state to which the application is transferred when moving to the payment gateway', 'wc_visa'),
                        'type' => 'select',
                        'default' => "on-hold",
            ...
            public function process_payment($order_id)
            {
                ...
                $order->update_status($this->pending_order_status, __('Awaiting cheque payment', 'woocommerce'));
