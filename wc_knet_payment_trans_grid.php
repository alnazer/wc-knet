...
class wc_knet_payment_trans_grid extends WP_List_Table
{
    ...
    public function no_items() {
        _e( 'No Transactions avaliable.',  "wc-knet" );
    }
    public function get_columns()
    {
            return $columns= array(
                'order_id'=>__('Order', "wc-knet"),
                'customer_name' => __( 'Customer Name', "wc-knet" ),
                'customer_email' => __( 'Customer Email', "wc-knet" ),
                'customer_mobile' => __( 'Customer Mobile', "wc-knet" ),
                ...
                'ref_id'=>__('Reference id', "wc-knet"),
    ...
    public function column_default( $item, $column_name ) {
        ...
        switch ( $column_name ) {
            ...
            case "customer_name":
                return (!empty($order))? $order->get_formatted_billing_full_name() : "---";
            case "customer_email":
	            return (!empty($order))? $order->get_billing_email() : "---";
	        case "customer_mobile":
		        return (!empty($order))? $order->get_billing_phone() : "---";;
                default:
...
// class constructor
    ...
    public function screen_option() {
        ...
        $this->transactions_obj = new wc_knet_payment_trans_grid();
    ...
    public function plugin_settings_page() {
        ...
        <div class="wrap">
            ...
            <div style="display: flex;gap: 3rem;">
                ...
                <div id="post-body" class="metabox-holder columns-2">
                    <?php $this->transactions_obj->search_box(_e( 'Filter', 'wc-knet' ), "wc_knet_filter") ?>
                </div>
            </div>
        </div>
        <?php
